...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\__ Моя Папка\Учёба\нейросети\bot_dissia\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\__ Моя Папка\Учёба\нейросети\bot_dissia\venv\Scripts\deactivate.nu'
